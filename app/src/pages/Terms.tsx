	...
	return (
		<div style={pageStyle}>
			<div style={containerStyle}>
				...
				<p style={pStyle}>
					<strong>Support contact:</strong> For help with the program or your account, contact us at support@honeytext.com (replace with your actual support email or other contact).
				</p>
				<p style={pStyle}>
